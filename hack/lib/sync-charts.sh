...
echo "git clone"
cd ..
git config --global user.email "houxc_mail@163.com"
git config --global user.name "xavier-hou"
git clone --single-branch --depth 1 git@github.com:xavier-hou/openyurt-helm.git openyurt-helm
